...
6. Se necessario, verifica che il profilo del dispositivo sia conforme alle specifiche OpenModbusSpecs (cfr. https://github.com/stekker/OpenModbusSpecs/tree/main). 
